		...
		switch (newvideotype) {
			...
			case "youtube":
				...
				// CHECK VIDEO ORIGIN, AND EXTEND WITH WWW IN CASE IT IS MISSING !
			 	...
			 	_nc.data('videomarkup','<iframe style="visible:hidden" id="YT'+vidytid+'" src="'+httpprefix+'://www.youtube.com/embed/'+vidytid+'?'+vida_new+'" '+yafv+' width="100%" height="100%" style="width:100%;height:100%"></iframe>');
			break;
