<?php
class Olegnax_Athlete_Block_Product_List_New extends Mage_Catalog_Block_Product_List
{
	...
	protected function _construct()
	{
		$this->addData(array(
			...
			'cache_tags'     => array('olegnax_athlete_product_list_new'),
		));
	}
