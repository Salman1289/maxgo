 ...
 *
 * @category    Mage
 * @package     Olegnax_Colorswatches
 * @copyright  Copyright (c) 2006-2014 X.commerce, Inc. (http://www.magento.com)
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class Olegnax_Colorswatches_Model_Resource_Catalog_Product_Type_Configurable_Product_Collection
    extends Mage_Catalog_Model_Resource_Product_Type_Configurable_Product_Collection
{
     ...
     * @param bool $logQuery
     * @throws Exception
     * @return Olegnax_Colorswatches_Model_Resource_Catalog_Product_Type_Configurable_Product_Collection
     */
