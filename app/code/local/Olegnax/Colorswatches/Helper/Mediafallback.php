...
class Olegnax_Colorswatches_Helper_Mediafallback extends Mage_Core_Helper_Abstract {
    ...
    {
        $listSwatchAttr = Mage::helper('olegnaxcolorswatches/productlist')->getSwatchAttribute();
        ...
        $configAttributes = Mage::getResourceModel('olegnaxcolorswatches/catalog_product_attribute_super_collection')
            ...
            foreach ($configAttributes as $attribute) {
                ...
                foreach ($parentProduct->getChildrenProducts() as $childProduct) {
                    ...
                    $optionLabels = array_map(function ($value) {
                        return array_map('Olegnax_Colorswatches_Helper_Data::normalizeKey', $value);
                    }, $optionLabels);
