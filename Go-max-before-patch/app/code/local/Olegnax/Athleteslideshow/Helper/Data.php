...
class Olegnax_Athleteslideshow_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	{
		if(Mage::helper('core')->isModuleEnabled('Nwdthemes_All') && Mage::helper('core')->isModuleOutputEnabled('Nwdthemes_All') && Mage::helper('core')->isModuleEnabled('Nwdthemes_Revslider') && Mage::helper('core')->isModuleOutputEnabled('Nwdthemes_Revslider') && Mage::helper('nwdall')->getCfg('general/enabled', 'nwdrevslider_config'))
		{
			return true;
		}
		return false;
