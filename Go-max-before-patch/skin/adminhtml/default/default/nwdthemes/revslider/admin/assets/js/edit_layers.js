...
UniteLayersRev = new function(){
	...
	***************************************/
	t.refreshGridSize = function(){
		...
		for(var key in arrLayers) if (arrLayers.hasOwnProperty(key)) {
	...
	*****************************************************/
	...
	var updateLayersImageSizes = function(){
		...
		for (serial in arrLayers) if (arrLayers.hasOwnProperty(serial)) {
	...
	var deleteLayerFromObject = function(serial){
		...
		var arrLayersNew = {};
		var flagFound = false;
		for (key in arrLayers) if (arrLayers.hasOwnProperty(key)) {
			if(key != serial)
...
//======================================================
    ...
    t.addPreventLeave = function(){
        ...
        window.onbeforeunload = function (e) {
            if( ! disable_leave_confirmation && save_needed){
