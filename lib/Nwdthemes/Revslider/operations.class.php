...
class RevSliderOperations extends RevSliderElementsBase{
	...
	public static function updateStaticCss($content){
		...
		if ( Mage::helper('nwdrevslider/framework')->is_multisite() ){
			...
			$c = Mage::helper('nwdrevslider/framework')->update_option('revslider-static-css', $content);
		}
			...
			<html>
				...
				<body style="padding:0px;margin:0px;width:100%;height:100%;position:relative;">
					...
					if($wpmlActive == true){
                        ...
                        <?php echo Mage::helper('nwdrevslider')->__("Choose language"); ?>: <?php echo $selectLangChoose; ?>
						</div>
...
ob_end_clean();
	...
	public function checkPurchaseVerification($data){
		...
		if($version_info == 'valid'){
			...
			RevSliderFunctions::throwError(__('Purchase Code already registered!'));
		}else{
			return false;
		}
...
$presets[] = array (
	...
	public static function add_preset_setting($data){
		...
		Mage::helper('nwdrevslider/framework')->update_option('revslider_presets', $customer_presets);
