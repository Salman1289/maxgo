...
class RevSliderFront extends RevSliderBaseFront{
	...
	public static function onAddScripts(){
		...
		Mage::helper('nwdrevslider/framework')->wp_enqueue_style('rs-plugin-settings', RS_PLUGIN_URL .'public/assets/css/settings.css', array(), $slver);
		...
		if($includesFooter == "off"){
			...
			if($enable_logs == 'on'){
				Mage::helper('nwdrevslider/framework')->wp_enqueue_script('enable-logs', RS_PLUGIN_URL .'public/assets/js/jquery.themepunch.enablelog.js', $waitfor, $slver);
				$waitfor[] = 'enable-logs';
			}
			
			Mage::helper('nwdrevslider/framework')->wp_enqueue_script('tp-tools', RS_PLUGIN_URL .'public/assets/js/jquery.themepunch.tools.min.js', $waitfor, $slver);
			Mage::helper('nwdrevslider/framework')->wp_enqueue_script('revmin', RS_PLUGIN_URL .'public/assets/js/jquery.themepunch.revolution.min.js', 'tp-tools', $slver);
			
		}else{
			//put javascript to footer

			Mage::helper('nwdrevslider/framework')->add_action('wp_footer', array('RevSliderFront', 'putJavascript'));
		}
